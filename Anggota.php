      ...
      <div class="row">
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header with-border">
              ...
              <form action="anggota.php" method="post" class="form-horizontal">
              <div class="box-body">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Kode Anggota</label>

                  <div class="col-sm-10">
                    <input type="text" name="kode_anggota" class="form-control" id="inputEmail3" required="required" value="<?php echo generateKode('id', 'anggota'); ?>" readonly>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Nama Direktur</label>
                      <div class="col-sm-4">
                        <input type="text" name="nama_direktur" class="form-control" id="inputEmail3" placeholder="Masukkan Nama Direktur" required="required">
                      </div>
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input type="text" name="bpc_askopindo" class="form-control" id="inputEmail3" placeholder="BPC" required="required">
                    </div>
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-hover">
                ...
                <?php 
                  ...
                  $open = mysqli_query($openServer, $anggota);
                ...
                <tr>
                  ...
                  <td><?php echo $row['bpc_askopindo']; ?></td>
                  ...
                  <td>
                    ...
                    <button type="button" rel="tooltip" title="Edit" class="btn btn-success btn-simple btn-xs">
                        <a href="editAnggota.php?edit=<?php echo $row['id']; ?>"<i style="color: #fff;" class="fa fa-edit"></i></a>
                    </button>
       ...
       <?php 
          ...
          if (isset($_POST['simpan'])) {
            ...
            $qInsert ="INSERT INTO anggota(kode_anggota, nama_direktur, nama_cv, bpc_askopindo, alamat, no_telpon, email)VALUES('$kode_anggota', '$nama_direktur', '$nama_cv', '$bpc_askopindo', '$alamat', '$no_telpon', '$email')";
          ...
          if (isset($_GET['hapus'])) {
            ...
            $qdelete ="DELETE FROM anggota WHERE id='$_GET[hapus]'";
